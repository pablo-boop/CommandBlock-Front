      ...
      <div className={styles.container}>
        ...
        <div className={styles.vagasDetalhes}>
          ...
          <p className={styles.text}>
            ...
            comprometida com a formação de profissionais e o desenvolvimento da
            indústria brasileira. Estamos contratando para diversas áreas com
            vagas efetivas, oferecendo não apenas um emprego, mas uma
            oportunidade de crescimento em um ambiente que valoriza a inovação,
            a educação de qualidade e o desenvolvimento contínuo.
          </p>
        </div>
      </div>
    </div>
